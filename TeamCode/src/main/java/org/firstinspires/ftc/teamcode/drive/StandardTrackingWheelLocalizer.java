...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double WHEEL_RADIUS = 0.629921f; // in
    public static double GEAR_RATIO = 1; // output (wheel) speed / input (encoder) speed

    public static double X_MULT = 1;
    public static double Y_MULT = 1;

    public static double LATERAL_DISTANCE = 5.5f; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = 4.5f; // in; offset of the lateral wheel
